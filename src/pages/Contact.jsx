                ...
                <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
                    <div className="mb-4">
                        <div className="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
                            ...
                            <p className="mx-auto mt-4 max-w-3xl text-xl text-gray-600 dark:text-slate-400">We are always ready to support you.
                            </p>
                        </div>
                    </div>
                                ...
                                <ul className="mb-6 md:mb-0">
                                    <li className="flex">
                                        ...
                                        <div className="ml-4 mb-4">
                                            ...
                                            <p className="text-gray-600 dark:text-slate-400">GMK Bulvarı No:140 / Anadolu Meydanı</p>
                                            <p className="text-gray-600 dark:text-slate-400">Çankaya/ANKARA</p>
                                        </div>
                                    </li>
                                    <li className="flex">
                                        <div className="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
